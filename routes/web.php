...
Route::get('/tag/delete/{tag}', 'HomeController@destroyTag')->name('delete_tag');
////for category
...
Route::get('/category/delete/{category}', 'HomeController@destroyCategory')->name('delete_category');
...
Route::get('/search/place/delete/{place}', 'PlacesController@destroy_from_search')->name('delete_object_search');
Route::get('/user/place/delete/{place}', 'PlacesController@destroy_from_userProfile')->name('delete_object_userProfile');
...
Route::get('/user/review/delete/{review}', 'ReviewsController@destroy_fromUserProfile')->name('delete_review_FromUserProfile');
Route::get('/search/review/delete/{review}', 'ReviewsController@destroy')->name('delete_review');
...
Route::get('/location/delete/{location}', 'LocationsController@destroy')->name('delete_location');
...
Route::get('/approve/place/delete/{place}', 'PlacesController@destroy_from_approve')->name('delete_object_approve')->middleware('admin');
//users
